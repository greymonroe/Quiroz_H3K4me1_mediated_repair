...
contexts_plot(somatic[trt=="WT" ]$context_SBS,full=F)[[2]]+scale_y_continuous(name="Mutations")+ggtitle("wt/wt + wt/msh6")
contexts_plot(somatic[trt=="MSH6"]$context_SBS,full=F)[[2]]+scale_y_continuous(name="Mutations")+ggtitle("msh6/msh6")
...
pdf("Figures/MSH6_loc_germline.pdf", width=2.75, height=2)
...
fixed<-counts[,.(pct=N/max(N),N=N, unique=V1), by=.(geno=V2)]
